...
function initFormHandler() {
	...
	form.addEventListener('submit', function(event) {
		...
		recipeElement.data = recipeData;
		document.querySelector('main').append(recipeElement);
		
		let recipesList = getRecipesFromStorage();
		recipesList.push(recipeData);
		saveRecipesToStorage(recipesList);
	});

	// B10. TODO - Get a reference to the "Clear Local Storage" button
	const clsButton = document.querySelector('button[class="danger"]');
